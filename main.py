...
class CALORIES_BURNT_PREDICT:
    ...
    def load_data(self, calories_file, exercise_file):
        try:
            ...
            self.df.drop(columns=['User_ID'], inplace=True)
...
if __name__ == "__main__":
    try:
        ...
        obj = CALORIES_BURNT_PREDICT()
        obj.load_data("D:\\projects\\Calories_Burnt\\pythonProject1\\calories (1).csv",
            "D:\\projects\\Calories_Burnt\\pythonProject1\\exercise.csv")
